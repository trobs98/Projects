...
/**
 * @author kkontog, ktsiouni, mgrigori the base Interface for the Subscriber
 *         hierarchy
 */
public abstract class AbstractSubscriber implements IEntity {
	 ...
	 * 
	 * @param stateName
	 *            the entry from the {@link StateName} enumeration that we want the
	 *            new IState of the ISubscriber to be
	 */
	 ...
	 * 
	 * @param event
	 *            the AbstractEvent that's received
	 * @param channelName
	 *            the name of the channel that sent the AbstractEvent to the
	 *            ISubscriber
	 */
	...
	/**
	 * Return ID associated with subscriber
	 * 
	 * @return ID type int
	 */
	public int getID() {
